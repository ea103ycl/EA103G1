...
//會員註冊
		if ("InsertMem".equals(action)) {
			...
			try {
				...
				memSvc.addMem(1, usrid, confirmpsw, name, gender, null, null, mobile, zipcode, city, address, email,
						null, null, 1, 1, 1, 0, 0);
		...
		if ("UpdateMem".equals(action)) {
			...
			try {
				...
				memSvc.updateByUser(name, gender, bday, phone, mobile, contactZipcode, contactCity, contactAddress,
						email, mem_id);
