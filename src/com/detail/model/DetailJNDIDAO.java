...
public class DetailJNDIDAO implements DetailDAO_interface {
	...
	public void insert(DetailVO detailVO,Connection con) {
		...
		try {
			...
			pstmt.setInt(1,    detailVO.getProd_no());
			pstmt.setInt(2,    detailVO.getOr_qty());
			pstmt.setInt(3,    detailVO.getOr_p_price());
