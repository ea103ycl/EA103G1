							...
							<c:forEach var="painterVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<div class="post-block ycl-post-block">
										<!-- 作品圖片 -->				
										<a href="<%=request.getContextPath()%>/frontend/painter/onePainter.jsp?ptr_no=${painterVO.ptr_no}&src=3&spg=<%=whichPage%>">
										...
										<div class="ycl-painter-content">
											...
											<div class="ycl-small-post-footer">
												...
												<span class="post-icons ycl-post-icons">
													<button class="ycl-act-btn-msg" value="${painterVO.ptr_no}" onclick="location.href='<%=request.getContextPath()%>/frontend/painter/onePainter.jsp?ptr_no=${painterVO.ptr_no}&src=3&spg=<%=whichPage%>'">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        ...
			        <form method="post" action="<%=request.getContextPath()%>/painter/painter.do" enctype="multipart/form-data">
	                    ...
	                    <div class="form-group">
	                        <label>作品說明</label>
	                        <textarea class="form-control" id="intro" name="intro" rows="5" placeholder="請輸入作品說明"></textarea>
	                    </div>
