...
//          let bdEnd = "Oct 31, 2020 18:00:00",
            let bdEnd ='<c:choose><c:when test="${bdr.runningBd.bdNo eq bdNo}">${bdr.runningBd.bdDateEnd}</c:when><c:otherwise>0</c:otherwise></c:choose>',
                countDown = new Date(bdEnd).getTime(),
