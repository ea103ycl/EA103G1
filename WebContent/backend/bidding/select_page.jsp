...
<head>
  ...
  <link href="<%=request.getContextPath()%>/backend/bidding/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
  <!-- Custom styles for this template -->
  <link href="<%=request.getContextPath()%>/backend/bidding/css/sb-admin-2.min.css" rel="stylesheet">
  <!-- Custom styles for this page -->
  <link href="<%=request.getContextPath()%>/backend/bidding/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
</head>
...
<body id="page-top">
  ...
  <div id="wrapper">
                ...
                <li class="nav-item">
                  ...
                  <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                      ...
                      <!-- Begin Page Content -->
                      <jsp:useBean id="bVO" scope="request" class="com.bidding.model.BiddingVO"/>
                  ...
                  <ul>
                    <li><a href='listAll.jsp'>List</a> all BiddingRecord  <br><br></li>


                    <li>
                      <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/bidding/BiddingServlet">
                        <b>輸入競標編號 :</b>
                        <input type="text" name="bdNo">
                        <input type="hidden" name="action" value="getOne">
                        <input type="submit" value="送出">
                      </FORM>
                    </li>

                    <jsp:useBean id="biddingSvc" scope="page" class="com.bidding.model.BiddingService" />

                    <li>
                     <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/bidding/BiddingServlet" >
                       <b>選擇競標編號:</b>
                       <select size="1" name="bdNo">
    ...
    <script src="<%=request.getContextPath()%>/backend/bidding/vendor/jquery/jquery.min.js"></script>
    <script src="<%=request.getContextPath()%>/backend/bidding/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- Core plugin JavaScript-->
    <script src="<%=request.getContextPath()%>/backend/bidding/vendor/jquery-easing/jquery.easing.min.js"></script>
    <!-- Custom scripts for all pages-->
    <script src="<%=request.getContextPath()%>/backend/bidding/js/sb-admin-2.min.js"></script>
    <!-- Page level plugins -->
    <script src="<%=request.getContextPath()%>/backend/bidding/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="<%=request.getContextPath()%>/backend/bidding/vendor/datatables/dataTables.bootstrap4.min.js"></script>
    <!-- Page level custom scripts -->
    <script src="<%=request.getContextPath()%>/backend/bidding/js/demo/datatables-demo.js"></script>
