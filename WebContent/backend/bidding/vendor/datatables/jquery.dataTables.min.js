        ...
        (function(h) { "function" === typeof define && define.amd ? define(["jquery"], function(E) { return h(E, window, document) }) : "object" === typeof exports ? module.exports = function(E, H) { E || (E = window);
            ...
            function la(a, b, c) {
                ...
                if (!b.sWidthOrig) { b.sWidthOrig = e.attr("width") || null; var f = (e.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/);
                    f && (b.sWidthOrig = f[1]) } c !== k && null !== c && (hb(c), J(n.defaults.column, c, !0), c.mDataProp !== k && !c.mData && (c.mData = c.mDataProp), c.sType && (b._sManualType = c.sType), c.className && !c.sClass && (c.sClass = c.className), c.sClass && e.addClass(c.sClass), h.extend(b, c), F(b, c, "sWidth", "sWidthOrig"), c.iDataSort !== k && (b.aDataSort = [c.iDataSort]), F(b, c, "aDataSort"));
                var g = b.mData,
                    j = S(g),
                    i =
            ...
            function Ia(a) {
                ...
                for (f = b.length; e < f; e++)
                    ...
                    for (j = d.length; g < j; g++) { i = 0; for (h = c.length; i < h; i++) { u[i] === k && (u[i] = B(a, i, e, "type"));
                            q = d[g](u[i], a); if (!q && g !== d.length - 1) break; if ("html" === q) break } if (q) { m.sType = q; break } } m.sType || (m.sType = "string")
                }
            }
                ...
                if ("string" === typeof a &&
                    ...
                    var c = function(a, b, f) { var g, j; if ("" !== f) { j = La(f); for (var i = 0, l = j.length; i < l; i++) { f = j[i].match(da);
                                g = j[i].match(X); if (f) { j[i] = j[i].replace(da, ""); "" !== j[i] && (a = a[j[i]]);
                                    g = [];
                                    j.splice(0, i + 1);
                                    j = j.join("."); if (h.isArray(a)) { i = 0; for (l = a.length; i < l; i++) g.push(c(a[i], b, j)) } a = f[0].substring(1, f[0].length - 1);
                    ...
                    for (e = g.length; d < e; d++) { if (a = g[d].nTr)
                        ...
                        f = 0; for (b = g[d].length; f < b; f++)
                            if (l = i = 1, j[d][f] === k) { a.appendChild(g[d][f].cell); for (j[d][f] = 1; g[d + i] !== k && g[d][f].cell == g[d + i][f].cell;) j[d + i][f] = 1, i++; for (; g[d][f + l] !== k && g[d][f].cell == g[d][f + l].cell;) { for (c = 0; c < i; c++) j[d + c][f + l] = 1;
                                    l++ } h(g[d][f].cell).attr("rowspan", i).attr("colspan", l) } }
                }
            }
            ...
            function fa(a, b) {
                ...
                for (i = c.length; f < i; f++) { d = c[f]; for (e = d.firstChild; e;) { if ("TD" == e.nodeName.toUpperCase() || "TH" == e.nodeName.toUpperCase()) { m = 1 * e.getAttribute("colspan");
                            ...
                            k = 1 === m ? !0 : !1; for (j = 0; j < m; j++)
                                for (g = 0; g < q; g++) a[f + g][l + j] = { cell: e, unique: k }, a[f + g].nTr = d } e = e.nextSibling } }
            }
                            ...
                            var V = p.oFeatures,
                                e = function() {
                                    if (g.aaSorting === k) { var a = p.aaSorting;
                                        j = 0; for (i = a.length; j < i; j++) a[j][1] = p.aoColumns[j].asSorting[0] } ya(p);
                ...
                if (h.isArray(a))
                    ...
                    for (var e = a.split("."), f = Tb, g, j, c = 0, d = e.length; c < d; c++) {
                        ...
                        a: { i = 0; for (var l = f.length; i < l; i++)
                                if (f[i].name === g) { i = f[i]; break a } i = null } i || (i = { name: g, val: {}, methodExt: [], propExt: [], type: "object" }, f.push(i));
            ...
            var bb = function(a, b, c, d, e) { var f = [],
                    ...
                    i = 0; for (l = b.length; i < l; i++) { j = b[i] && b[i].split && !b[i].match(/[\[\(:]/) ? b[i].split(",") : [b[i]];
                        m = 0; for (n = j.length; m < n; m++)(g = c("string" === typeof j[m] ? h.trim(j[m]) : j[m])) && g.length && (f = f.concat(g)) } a = v.selector[a]; if (a.length) { i = 0; for (l = a.length; i < l; i++) f = a[i](d, e, f) } return ra(f) },
                cb = function(a) {
                    a || (a = {});
                ...
                var b = cb(b),
                    c = this.iterator("table", function(c) {
                        ...
                        return bb("row", a, function(a) {
                            ...
                            if (typeof a === "string" && a.charAt(0) === "#") { b = c.aIds[a.replace(/^#/, "")]; if (b !== k) return [b.idx] } b =
            ...
            s("rows().remove()", "row().remove()", function() {
                ...
                this.iterator("row", function(b, c, d) { var e = b.aoData,
                    ...
                    g = 0; for (h = e.length; g < h; g++)
                        if (i = e[g], m = i.anCells, null !== i.nTr && (i.nTr._DT_RowIndex = g), null !== m) { i = 0; for (l = m.length; i < l; i++) m[i]._DT_CellIndex.row = g } qa(b.aiDisplayMaster, c);
                    qa(b.aiDisplay, c);
                    qa(a[d], c, !1);
                ...
                pageButton: {
                    _: function(a, b, c, d, e, f) {
                        var g = a.oClasses,
                            ...
                            s;
                        try { s = h(b).find(H.activeElement).data("dt-idx") } catch (r) {} o(h(b).empty(), d);
