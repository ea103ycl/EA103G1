...
<body class="uf-body">
<script type="text/javascript" src="tools/getUrlParam.js"></script>
<script>
    var EVENT_NO = UrlParam.paramValues("EVENT_NO");
    console.log(typeof EVENT_NO);
    console.log(EVENT_NO);
    console.log(EVENT_NO[0]);
