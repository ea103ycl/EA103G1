...
<%
    ...
    List <WelRecordVO> list = welRecordSvc.getWelRecordByMemID(request.getParameter("mem_id"));
    pageContext.setAttribute("set",list);
%>
...
<body id="page-top">
	...
	<ul>
     ...
     <c:forEach var="welRecordVO" items="${set}">
