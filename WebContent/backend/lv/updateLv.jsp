			...
			<div id="content-wrapper" class="d-flex flex-column">		
				...
				<div id="content">
					...
					<div class="container-fluid">				
						...
						<%-- 頁面標題 --%>
						<h1 class="h3 mb-2 text-gray-800">修改里程碑</h1>
						...
						<form method="post" class="form-group"
							...
							<div class="form-group">
								<label for="lv">里程碑等級流水號</label>							
								<input type="text" readonly
									class="form-control" id="lv" name="lv"
									value="<%= (lvVO==null) ? "" : lvVO.getLv()%>">
							</div>
							...
							<div class="form-group">
								...
								<input type="number"
								    <c:if test="${lvVO.lv==1}">readonly</c:if>
							...
							<div class="form-group">
								...
								<img class="img-fluid w-25 h-25" id="imgUpload"
								     src="<%=request.getContextPath()%>/lv/lv.do?action=showPic&lv=${lvVO.lv}">							
							</div>
